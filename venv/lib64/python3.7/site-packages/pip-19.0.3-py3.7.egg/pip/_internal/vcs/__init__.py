...
class RevOptions(object):
    ...
    def to_args(self):
        # type: () -> List[str]
        """
        Return the VCS-specific job_commands arguments.
        """
        args = []  # type: List[str]
        rev = self.arg_rev
        if rev is not None:
...
class VersionControl(object):
    ...
    def get_base_rev_args(self, rev):
        """
        Return the base revision arguments for a vcs job_commands.
    ...
    def run_command(
        ...
        job_commands name, and checks that the VCS is available
        """
        cmd = [cls.name] + cmd
        try:
            ...
            if e.errno == errno.ENOENT:
                raise BadCommand(
                    'Cannot find job_commands %r - do you have '
