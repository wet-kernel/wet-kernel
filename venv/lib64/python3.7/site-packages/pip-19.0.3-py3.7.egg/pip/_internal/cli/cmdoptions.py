...
def no_cache_dir_callback(option, opt, value, parser):
    ...
    # job_commands-line, since the option doesn't accept arguments.  However,
...
def no_use_pep517_callback(option, opt, value, parser):
    ...
    # will be None if --no-use-pep517 is passed via the job_commands-line.
    ...
    # Otherwise, --no-use-pep517 was passed via the job_commands-line.
...
install_options = partial(
    ...
    help="Extra arguments to be supplied to the setup.py install "
         "job_commands (use like --install-option=\"--install-scripts=/usr/local/"
...
global_options = partial(
    ...
    help="Extra global options to be supplied to the setup.py "
         "call before the install job_commands.",
)  # type: Callable[..., Option]
